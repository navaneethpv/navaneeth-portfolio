    ...
    <section id="experience" className="w-full border-b border-border">
      ...
      <div className="flex flex-col divide-y divide-border">
        {experience.map((item, idx) => (
          ...
          >
            {/* Period & Company side */}
            <div className="px-8 sm:px-12 md:px-16 py-8 md:py-12 md:col-span-1 flex flex-col justify-between">
            ...
            {/* Title & Description */}
            <div className="px-8 sm:px-14 md:px-20 lg:px-24 py-8 md:py-12 md:col-span-3 space-y-6">
